...
task1: SpeishFlag{DCUuhc0WShG69E0H7kF6V2LIxLu7O2gi}
...
Am dat cu objdump -d -M intel pe el si am descoperit un strcmp in main

Am rulat exec-ul si nu mergea, si am zis sa ii dau un argument, dar nimic

Din hinturi am dat ltrace si pe robot-sudo start si am descoperit ca face un fopen la un conf
/usr/share/potisate/askunzi/robosudo.conf, dar care nu putea fi vzt decat de roombax.

Am dat ltrace pe exec (Try to ltrace the setuid binaries), si cu
si fara argument (am incercat comanda start), si am observat ca atunci cand dau cu argument apare un strcmp

Am folosit al doilea argument al strcmp-ului ca argument si executabilul nu a mai dat Acces denied
640c6109e10f7eb4ae07a270901ae675
...
am dat un whoami ;) in copia de mai jos)
...
un cat pe calea ascunsa cu conful si execul cu argumentul descoperit

Am modificat janitor_vacum.sh si am pus in schimb apelarea copiei vacum_control_cpy

Prin rularea ./janitor_vacum.sh am extras comenzi de allow dar deja descoperisem asta si flagul

task2: SpeishFlag{UexHZeX086slqwGTnmJnE9jJOliEoMg1}
...
Am descoperit din main ca daca introduci numele Florin Salam, se afiseaza un easter egg cu un link =))
...
task3: SpeishFlag{raYlIeeYuRKcc1IloUeM3x2HPI1JiOFy}